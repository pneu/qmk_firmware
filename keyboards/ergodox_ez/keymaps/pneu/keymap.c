...
#define EXTL 3 // extesion keys
#define SUPL 4 // supplemental keys
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        GUI_T(KC_RBRC), KC_A,                 KC_S,     KC_D,     KC_F,    KC_G,
        SFT_T(KC_EQL),  KC_Z,                 KC_X,     KC_C,     KC_V,    KC_B,   SFT_T(ALT_T(KC_ESC)),
        LT(SYMB,KC_NO), SFT_T(ALT_T(KC_RO)),  KC_NO,    KC_LALT,  CTL_T(KC_NO),
                                                      KC_END,                KC_HOME,
                                                                             KC_PGUP,
 ...
 * |        |      |      | MsUp |      |      |      |           |      |      |      |      |      |      |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |      |MsLeft|MsDown|MsRght| WhUp |------|           |------|      |      |      |      |      |  Play  |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |      |      |      |      | WhDn |      |           |      |      |      | Prev | Next |      |        |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      |      |      |      |      |                                       |VolUp |VolDn | Mute |      |      |
...
[EXTL] = KEYMAP(
       KC_TRNS, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_F5,   KC_TRNS, KC_TRNS,
       KC_TRNS, KC_TRNS, KC_SCROLLLOCK, KC_TRNS, KC_TRNS, KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
                                           KC_TRNS, KC_TRNS,
                                                    KC_TRNS,
